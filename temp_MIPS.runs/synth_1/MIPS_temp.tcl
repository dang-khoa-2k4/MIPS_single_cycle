...
read_verilog -library xil_defaultlib {
  ...
  {C:/Users/ADMIN/OneDrive - hcmut.edu.vn/University/Junior/Logic design project/single_cycle_MIPS/temp_MIPS.srcs/sources_1/imports/source/others.v}
...
synth_design -top MIPS_temp -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef MIPS_temp.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file MIPS_temp_utilization_synth.rpt -pb MIPS_temp_utilization_synth.pb"
